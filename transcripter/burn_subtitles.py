...
def create_subtitle_clips(subtitles, videosize, fontsize=24, font="Arial", color="white", debug=False):
    ...
    for subtitle in subtitles:
        ...
        text_clip = TextClip(subtitle.text, fontsize=fontsize, font=font, bg_color="black", size=(video_width*3/4, None), method="caption").set_start(start_time).set_durarion(duration)
